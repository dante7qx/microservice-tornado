CREATE DATABASE IF NOT EXISTS `microservice-tornado` DEFAULT CHARSET utf8 COLLATE utf8_general_ci;

USE `microservice-tornado`;
...
CREATE TABLE t_resource (  
	...
	service_module_id bigint(20) NOT NULL COMMENT '服务模块',
	authority_id bigint(20) NOT NULL COMMENT '权限Id', 
...
CREATE TABLE t_service_module (
	id bigint(20) NOT NULL, 
	name varchar(32) NOT NULL COMMENT '模块名',
	url varchar(32) NOT NULL COMMENT '模块URL',
	update_user bigint(20) NOT NULL default 1 COMMENT '更新人',
	update_date datetime NOT NULL default now() COMMENT '更新时间'
) 
ENGINE=InnoDB 
...
DROP TABLE IF EXISTS t_ip_rule;
CREATE TABLE t_ip_rule (
	...
	CONSTRAINT pk_t_ip_rule PRIMARY KEY (id)
)
ENGINE=InnoDB
DEFAULT CHARSET=utf8
COLLATE=utf8_general_ci
